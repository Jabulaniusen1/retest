...
export default function SupportPage() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: 'To close an account, please contact our support team via email at support@capitalbank.com or call us. We\'ll guide you through the process and ensure all pending transactions are settled.'
    },
    {
      category: 'Transfers',
    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <Card className="p-6 bg-gradient-to-br from-purple-500 to-purple-600 border-0 text-white">
          ...
          <a href="mailto:support@capitalbank.com" className="text-sm font-medium underline">
